...
userSchema.pre("save", async function () {
    if(!this.isModified("password")) return;   //->this condition helps in avoiding the recursive execution of 'password encryption' after change in any field of userSchema! 
